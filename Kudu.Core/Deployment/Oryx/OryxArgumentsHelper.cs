...
namespace Kudu.Core.Deployment.Oryx
{
    internal static class OryxArgumentsHelper
    {
        ...
        {
            string pythonBuildVersion = System.Environment.GetEnvironmentVariable("KUDU_BUILD_VERSION");
            if(!string.IsNullOrEmpty(pythonBuildVersion) && pythonBuildVersion.Equals("0.0.1"))
            {
