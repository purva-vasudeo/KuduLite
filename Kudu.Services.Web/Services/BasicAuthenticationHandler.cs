...
namespace Kudu.Services.Web.Services
{
    public class BasicAuthenticationHandler : AuthenticationHandler<AuthenticationSchemeOptions>
    {
        ...
        private static KuduMemCache<string> memCache = new KuduMemCache<string>();
        ...
        public static KuduMemCache<string> MemCache => MemCache1;

        public static KuduMemCache<string> MemCache1 => memCache;
